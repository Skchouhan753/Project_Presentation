let navbar = () => {
  ...
  <div id="Fixed">
    <div id="Home_Buttons">
      ...
      <a href="#"
        ><img
          class="H_but"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWXI_JyOVRGL5fOKjn9qMUF3pWkgFcfDm1oQ&usqp=CAU"
          alt=""
      /></a>
      ...
      <a href="../html/Login.html"
        ><img
          class="H_but"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwwJnHBJdUyCsrW7qVQ8vdXeTmdRD6Js9Pmg&usqp=CAU"
          alt=""
      /></a>
      <a href="../html/cart.html"
        ><img
          class="H_but"
          src="https://media.istockphoto.com/vectors/thin-line-shopping-bag-icon-illustration-design-vector-id653355496?k=20&m=653355496&s=170667a&w=0&h=VQQIU3uqbQuubef1qJCnAobIImZwE1LLbx51XIqQlPY="
          alt=""
        />
      </a>
    </div>
    <nav>
      <p class="hoverEff" id="Shoe_Hover">
        <a href="../ShoesPage/shoes.html">SHOES</a>
      </p>
      <p class="hoverEff" id="Hand_Hover">
        <a href="#">HANDBAGS & ACCESSORIES</a>
      </p>
      <p class="hoverEff" id="Design_Hover"><a href="#">DESIGNERS</a></p>
      <p class="hoverEff" id="Women-Hover">
        <a href="../clothing/clothing.html">CLOTHINGS</a>
      </p>
      <p class="hoverEff" id="Men_Hover"><a href="#">MEN</a></p>
      <p class="hoverEff" id="Sunglass_Hover">
        <a href="#">SUNGLASSES</a>
      </p>
      <p class="hoverEff" id="Watch_Hover">
        <a href="#">JEWELRY & WATCHES</a>
      </p>
      <p class="hoverEff" id="Under_Hover"><a href="#">UNDER $50</a></p>
      <p class="hoverEff" id="Beauty_Hover"><a href="#">BEAUTY</a></p>
    </nav>
    <div id="clearance"><a href="#" id="Clearance">CLEARANCE</a></div>
  </div>
  <div id="Spacediv"></div>
  <div class="SecNav" id="ShoesNav">
    <ul>
      <li>
        <a href="#"
          ><img
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="#">Oxford & Debry Shoes</a></li>
      ...
      <li>
        <a href="#">MEN'S DESIGNER'S</a>
        <ul>
          <li><a href="#">Antonio Maurizi</a></li>
  ...
  <div class="SecNav" id="DesignerNav">
    <ul>
      <li>
        <a href="#"
          ><img
  ...
  <div class="SecNav" id="MenNav">
    <ul>
      <li>
        <a href="#"
          ><img
            src="https://cdn.shopify.com/s/files/1/0248/3473/6191/files/men.jpg?v=1598516498"
            alt=""
          />
          <h5>DRESS SHIRTS</h5>
        </a>
  ...
  <div class="SecNav" id="SunglassNav">
    <ul>
      <li>
        <a href="#"
          ><img
  ...
  <div class="SecNav" id="JewelryNav">
    <ul>
      <li>
        <a href="#"
          ><img
            src="https://cdn.shopify.com/s/files/1/0248/3473/6191/files/watch.jpg?v=1598517674"
            alt=""
          />
          <h5>WATCHES</h5>
        </a>
      ...
      <li>
        <a href="#">TOP DESIGNER WATCHES A_J</a>
        <ul>
      ...
      <li>
        <a href="#">TOP DESIGNER WATCHES K-Z</a>
        <ul>
          <li><a href="#">Kate Spade</a></li>
  ...
  <div class="SecNav" id="UnderNav">
    <ul>
      <li>
        <a href="#">SHOP BY PRICEPOINT</a>
        <ul>
  ...
  <div class="SecNav" id="ClearanceNav">
    <ul>
      <li>
        <a href="#"
          ><img
